...
// elements.forEach((e, arrows) => {
//   e.style.color = "#fff";
//   e.innerHTML += `<span><i class="fa-solid fa-arrow-right cu-arrow"></i></span>`;
...
//     e.style.color = "#fff";
//   });
//   e.addEventListener("click", handleHover);
// });

// let arrows = document.querySelectorAll(".cu-arrow");
...
//   arrow.classList.add("cu-arrow");
// }

/* 
    <i class="fa-solid fa-arrow-right cu-arrow"></i>
