...
/* var rainfall =[];
for (var rainfallEach of weatherObj.rainfall.data){
    rainfall.push(rainfallEach.max+"毫米");
}
//console.log(rainfall);

var temperature=[];
var temperdata = weatherObj.temperature.data;
temperdata.forEach(temperdata => {
    temperature.push(temperdata.value +"度");  
});
